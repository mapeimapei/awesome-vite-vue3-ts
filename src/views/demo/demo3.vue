<template>
  ...
  <div class="p20 fx fx-fdc">
    ...
    <div class="box">
      <c1 ref="cc1" :name="state.name" :sex="state.sex" attr1="11111" attr2="22222" :attr3="state"
        v-model:up1="state.up1" v-model:up2="state.upup" @c1ChangeName="changeName">
      </c1>
